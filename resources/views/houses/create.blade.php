<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Create New House') }}</h2>    
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="pull-left">
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight"> Add New Houses</h2>
                    </div>
                    ...
                    <form action="{{ route('houses.store') }}" method="POST">
                        ...
                        <div class="grid grid-rows-2 gap-6">
                            <div class="form-group">
                                ...
                                <x-input id="adres" class="block mt-1 w-full"
                                         type="text"
                                         name="adres"/>
                            </div>
                            <div class="form-group">
                                <x-label for="wlasciciel" :value="__('Wlasciciel')" />
                                <x-input id="wlasciciel" class="block mt-1 w-full"
                                         type="text"
                                         name="wlasciciel"/>
                            </div>
                        </div>
